...
public class AccountController : ControllerBase
{
    ...
    public async Task<ActionResult<UserDTO>> Login(LoginDTO model)
    {
        ...
        if (result)
        {
            ...
            var cookieCart = await GetOrCreate(
                Request.Cookies["customerId"]!
            );
            ...
            //burada amacımız, dbdeki 2 farklı kartı ( birinde customerId diğerinde customer ismi olan kartları birleştirmek ve dbye kaydetmek)
