...
axios.defaults.withCredentials = true; // for cookies (backenddeki allowcredentials dan sonra burada da izin vermemiz gerekiyor.) ayrıca add to cart işlemi için gerekli. mevcut olan sepete ürünü eklemek için
